#' Whale speak
#'
#'@description This function is super fun and cute.
#'
#' @param what text string: what you want the whale to say.
#'
#' @return text string with a text whale and it saying a phrase.
#' @export
#'
#' @examples
#' say('Hello')
